...
def testB():
    ...
    """
    #correct call
    result=a1.get_lhs('{"ok":true, "lhs":"2 Namibian Dollars", "rhs":"2 Lesotho Maloti", "err":""}')
    introcs.assert_equals('2 Namibian Dollars', result)

    #correct call
    result=a1.get_rhs('{"ok":true, "lhs":"2 Namibian Dollars", "rhs":"2 Lesotho Maloti", "err":""}')
...
def testC():
    ...
    introcs.assert_equals('{ "ok":true, "lhs":"3 United States Dollars", "rhs":"20.642538 Chinese Yuan", "err":"" }', result)
